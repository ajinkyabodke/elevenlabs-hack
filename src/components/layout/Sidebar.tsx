...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "hidden h-full min-h-screen border-r border-white/20 bg-gradient-to-br from-violet-400/80 to-blue-400/80 text-black transition-all duration-300 md:block",
