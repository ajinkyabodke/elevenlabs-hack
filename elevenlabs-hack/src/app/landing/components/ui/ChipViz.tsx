    ...
    <div className="relative flex items-center">
      <div className="relative">
        <motion.div
          ...
          initial="initial"
          animate="animate"
          className="bg-linear-to-r absolute -inset-px z-0 rounded-full from-yellow-500 via-amber-500 to-orange-500 opacity-30 blur-xl"
        />
        <motion.div
          variants={createVariants({ scale: 1.08, delay: 0.1 })}
          initial="initial"
          animate="animate"
          className="bg-linear-to-b relative z-0 min-h-[80px] min-w-[80px] rounded-full border from-white to-orange-50 shadow-xl shadow-orange-500/20"
        >
          <motion.div
          ...
          >
            <div className="shadow-xs relative flex h-full w-full items-center justify-center overflow-hidden rounded-full bg-indigo-300 will-change-transform">
              ...
              <motion.div
                ...
                initial="initial"
                animate="animate"
                className="bg-linear-to-t absolute inset-0 rounded-full from-yellow-500 via-amber-500 to-orange-500 opacity-50 shadow-[inset_0_0_16px_4px_rgba(0,0,0,1)]"
              />
              <motion.div
